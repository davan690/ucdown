...
<!-- # # include_graphics(path = "figure/uw-100px.png") -->
<!-- # ``` -->
...
```{r subd, echo=FALSE, fig.cap="Subdiv. graph", out.extra="scale=0.75"}
# include_graphics("figure/UC_Logo.png")
```
...
```{r subd2, echo=FALSE, out.extra="angle=180, scale=1.1", fig.cap="A Larger Figure, Flipped Upside Down"}
# include_graphics("figure/logo.png")
```
