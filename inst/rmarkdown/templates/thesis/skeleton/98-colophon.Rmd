...
It was written in R Markdown and $\LaTeX$, and rendered into PDF using [ucdown](https://github.com/benmarwick/ucdown) and [bookdown](https://github.com/rstudio/bookdown). 
